                    ...
                    <div class="content-slide pointer-events-none fixed right-0 inset-y-0 flex w-1/3 pl-10 transform transition ease-in-out duration-500 translate-x-full sm:duration-700">
                        <div class="pointer-events-auto relative w-full ">
                            <div class="absolute left-0 top-0 -ml-8 flex pl-2 pt-4 sm:-ml-10 sm:pr-4">
                                <button type="button" class="close-contentbar rounded-md text-primary hover:text-primary-focus focus:outline-none focus:ring-2 focus:ring-white">
                                    <span class="sr-only">Close panel</span>
                                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                            ...
                            <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl ">
                                ...
                                <div class="flex justify-end border-slate-300 pt-4">
                                    <button type="submit" class="saveButton btn btn-primary font-bold text-slate-100 py-1.5 px-4 rounded  hover:primary-focus hover:text-slate-50 mr-2">Speichern</button>
                                    <button class="form-close btn font-bold bg-slate-200  text-slate-600 py-1.5 px-4 rounded  hover:bg-slate-300 hover:text-slate-900">Schließen</button>
                                </div>
                            </div>
                        </div>
                    </div>
